      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-[168px]">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-5 text-sm text-[#B5B5B5]" aria-label="Main navigation">
            <a href="/#generator"              className="hover:text-[#FF4655] transition-colors">Generator</a>
            <a href="/#tags-generator"         className="hover:text-[#FF4655] transition-colors flex items-center gap-1">
              <span className="text-[#FF4655]" aria-hidden="true">#</span>Tags
            </a>
            <a href="/valorant-shorts-titles"  className="hover:text-[#FF4655] transition-colors">Titles</a>
            <a href="/valorant-hashtags"       className="hover:text-[#FF4655] transition-colors">Hashtags</a>
            <a href="/about"                   className="hover:text-[#FF4655] transition-colors">About</a>
          </nav>

          <a href="/#generator" className="neon-btn text-white text-sm font-semibold px-4 py-2 rounded-lg">
            Try Free →
          </a>
        </div>
      </div>
