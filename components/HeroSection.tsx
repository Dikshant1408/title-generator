  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-20 pb-10 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        <div className="hero-fade-in inline-flex items-center gap-2 glass px-4 py-2 rounded-full text-sm text-purple-300 mb-8 border border-purple-500/30">
        ...
        <p className="hero-fade-in text-lg sm:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
        ...
        <div className="hero-fade-in flex flex-col sm:flex-row gap-4 justify-center mb-16">
          ...
          <a href="#examples" className="glass border border-purple-500/30 text-purple-300 font-semibold px-8 py-4 rounded-xl text-lg hover:border-purple-400/60 transition-all inline-flex items-center gap-2 justify-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-3xl mx-auto">
          {stats.map((stat) => (
            <div key={stat.label} className="glass-card p-4 text-center">
              <stat.icon className="w-5 h-5 text-purple-400 mx-auto mb-2" aria-hidden="true" />
        ...
        <div className="mt-16 flex flex-col items-center gap-2 text-slate-500">
          ...
          <div className="scroll-bounce w-5 h-8 border-2 border-purple-500/30 rounded-full flex items-start justify-center pt-1">
